...
from app.settings import settings  # Добавили импорт нашего конфига
from app.db.base import Base  # Добавили импорт нашей мета-БД
import app.models  # Добавили импорт модели, чтобы она инициализировалась, но она не используется
